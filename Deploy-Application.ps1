...
Try {
	...
	[string]$appScriptDate = '08/07/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Copy-File -Path "$dirSupportFiles\o_licenseserverurl.txt" -Destination "$envProgramFiles\Harris\license"
